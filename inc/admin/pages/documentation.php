...
?>
<div class="wrap">
<h2><i class="dashicons dashicons-twitter"></i> JM Twitter Cards : <?php echo esc_html( get_admin_page_title() ); ?></h2>
...
<div id="menu"> <h2><?php _e('Table of content','jm-tc-doc');?></h2>
...
<h2 id="3w"><?php echo __('What are Twitter Cards?','jm-tc-doc');?></h2> <a href="https://dev.twitter.com/docs/cards/getting-started"><?php _e('To GET STARTED:','jm-tc-doc');?></a>
<blockquote> <?php _e('Twitter cards make it possible for you to attach media experiences to Tweets that link to your content. Simply add a few lines of HTML to your webpages, and users who Tweet links to your content will have a "card" added to the Tweet that is visible to all of their followers.','jm-tc-doc');?> </blockquote>
<h2 id="getcards"><?php echo __('How to get Twitter Cards','jm-tc-doc');?></h2>
...
<h2 id="types"><?php _e('Different types of cards','jm-tc-doc');?></h2>
<h3 id="summarycards"><?php echo __('Summary cards','jm-tc-doc');?></h3>
<p><img src= "https://dev.twitter.com/sites/default/files/images_documentation/web_summary_1.png" alt="" /></p>
<h3 id="summarlargecards"><?php _e('Summary Large Image cards','jm-tc-doc');?></h3>
<p><img src= "https://dev.twitter.com/sites/default/files/images_documentation/web_summary_large.png" alt="" /></p>
...
<p><img src= "https://dev.twitter.com/sites/default/files/images_documentation/web_photo.png" alt= "" /></p>
<blockquote class="jm-doc"> <p><?php _e('The Photo Card puts the image front and center in the Tweet:','jm-tc-doc');?></p>
...
<p><img src= "https://dev.twitter.com/sites/default/files/images_documentation/web_product.png" alt= "" /></p>
...
<li><?php _e('Set twitter:player to point directly at a .swf movie file.','jm-tc-doc');?></li> </ul> </blockquote><strong><?php _e('Also be sure to check all the following point before <a href= "https://dev.twitter.com/docs/cards/validation/validator">asking for approval</a>. Here are the common issues with player cards:','jm-tc-doc');?></strong>
<blockquote> <ol> <li><?php _e('The HTTPS lock is showing active mixed content warnings','jm-tc-doc');?></li>
...
<li><?php _e('The player URL is not HTTPS (did we mention this before?)','jm-tc-doc');?></li> </ol> </blockquote>  <h2 id="deeplinking"><?php echo __('App install & Deep Linking','jm-tc-doc');?></h2> <br /> <blockquote>
...
<img src="https://dev.twitter.com/sites/default/files/images_documentation/blog-image_1.png" alt=""/><br /><br /> <blockquote>
...
<p class="bold"><?php _e('Be careful, it is not available in all countries ! Not yet','jm-tc-doc');?></p>
<h2 id="use"><?php echo __('Common Issues','jm-tc-doc');?></h2>
...
function disable_twitter_card_info() { if(is_page(array(19,'contact'))) remove_action('wp_head', 'add_twitter_card_info',99);
}
</pre>
<p><?php _e('Here I disable Twitter Cards for post with format \'status\':','jm-tc-doc');?></p> <pre>
add_action('wp_head','disable_twitter_card_info');
function disable_twitter_card_info() { if(has_post_format( 'status' )) remove_action('wp_head', 'add_twitter_card_info',99);
}
</pre>
...
function jmtc_modify_markup( $output ) { if( is_page (array('contact') ) ) {   return; }
}
add_filter( 'jmtc_markup', 'jmtc_modify_markup' );
</pre><?php _e('This could be another way to disable cards on some pages.','jm-tc-doc');?>
<p><strong><?php _e('Be careful with this. Manipulating markup in head section is quite sensitive.','jm-tc-doc');?></strong></p>
<h1 id="settings"><?php _e('Plugin options','jm-tc-doc');?></h1>
...
<h2 id="general"><?php echo __('General','jm-tc-doc');?></h2>
...
<p class="bold"><?php _e('If you experience any issue or if you mess with this option just recover with the key :','jm-tc-doc');?><br /> <strong>jm_tc_twitter</strong></p>
<h2 id="seo"><?php echo __('SEO','jm-tc-doc');?></h2>
...
<h2 id="images"><?php echo __('Images','jm-tc-doc');?></h2>
...
<h2 id="pagehome"><?php echo __('Home settings','jm-tc-doc');?></h2>
...
<h2 id="metabox"><?php _e('Meta Box','jm-tc-doc');?></h2>
...
<div class="footer"> <h1 id="sources"><?php _e('Sources','jm-tc-doc');?></h1>
