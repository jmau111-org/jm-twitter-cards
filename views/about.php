...
<div class="wrap">
	...
	$output .= '<a class="social button button-secondary dashicons-before dashicons-admin-site" href="https://tweetpress.fr" target="_blank" title="' . esc_attr__( 'My website', 'jm-tc' ) . '"><span class="visually-hidden">' . __( 'My website', 'jm-tc' ) . '</span></a>';
	$output .= '<a class="social button button-secondary link-like dashicons-before dashicons-twitter" href="https://twitter.com/intent/user?screen_name=tweetpressfr" title="' . esc_attr__( 'Follow me', 'jm-tc' ) . '"> <span class="visually-hidden">' . __( 'Follow me', 'jm-tc' ) . '</span></a>';
