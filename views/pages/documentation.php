...
<div class="wrap">
	...
	<br/>
	<img src="<?php echo esc_url( JM_TC_IMG_URL . 'doc/app_install.png' ); ?>" width="600" height="400"
	     alt=""/><br/><br/>
	<blockquote class="quote-doc">
...
Disallow:
	...
	<div class="footer"><h4 id="sources"><?php _e( 'Sources', JM_TC_DOC_TEXTDOMAIN ); ?></h4>
		...
		<p class="right pa1"><a href="#menu"><?php _e( 'Go To Table of Contents', JM_TC_DOC_TEXTDOMAIN ); ?></a></p>
	</div>
