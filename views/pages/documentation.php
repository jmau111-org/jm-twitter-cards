...
<ul class="menu"> <li><a href="#3w"><?php echo __('What are Twitter Cards?',JM_TC_DOC_TEXTDOMAIN);?></a></li>
...
<ul> <li><a href="#summarycards"><?php echo __('Summary cards',JM_TC_DOC_TEXTDOMAIN);?></a></li>
...
<li><a href="#playercards"><?php echo __('Player cards',JM_TC_DOC_TEXTDOMAIN);?></a></li> </ul> </li>
<li><a href="#deeplinking"><?php echo __('App install & Deep Linking',JM_TC_DOC_TEXTDOMAIN);?></a></li> <li><a href="#analytics"><?php _e('Analytics',JM_TC_DOC_TEXTDOMAIN);?></a></li>
<li> <a href="#use"><?php echo __('Common Issues',JM_TC_DOC_TEXTDOMAIN);?></a>
<ul> <li><a href="#faq-crawl"><?php _e('Twitter Card Validator does not work !',JM_TC_DOC_TEXTDOMAIN);?></a></li>
<li><a href="#faq-image"><?php echo __('I do not see images in tweets !',JM_TC_DOC_TEXTDOMAIN);?></a></li>
<li><a href="#faq-cf"><?php echo __('How do I use the custom fields option?',JM_TC_DOC_TEXTDOMAIN);?></a></li>
<li><a href="#faq-mb-option"><?php echo __('I do not see all options in meta box',JM_TC_DOC_TEXTDOMAIN);?></a></ul> </li>
<li> <a href="#settings"><?php echo __('Plugin settings',JM_TC_DOC_TEXTDOMAIN);?></a>
<ul> <li><a href="#general"><?php echo __('General',JM_TC_DOC_TEXTDOMAIN);?></a></li>
...
<li><a href="#extrasettings"><?php _e('Extrasettings',JM_TC_DOC_TEXTDOMAIN);?></a></li> </ul> </li>
<li><a href="#sources"><?php _e('Sources and Credits',JM_TC_DOC_TEXTDOMAIN);?></a></li> </ul> </div>
<h3 id="3w"><?php echo __('What are Twitter Cards?',JM_TC_DOC_TEXTDOMAIN);?></h3> <p><a href="https://dev.twitter.com/docs/cards/getting-started"><?php _e('To GET STARTED:',JM_TC_DOC_TEXTDOMAIN);?></a></p>
...
<ul class="jm-tools"> <li><a class="jm-preview" title="Twitter Cards Preview Tool" href= "https://cards-dev.twitter.com/validator" rel="nofollow" target= "_blank"><?php _e('Preview tool',JM_TC_DOC_TEXTDOMAIN);?></a></li>
<li><a class="jm-valid-card" title="Twitter Cards Application Form" href= "https://cards-dev.twitter.com/validator" rel="nofollow" target= "_blank"><?php _e('Validation form',JM_TC_DOC_TEXTDOMAIN);?></a></li> </ul>
...
<blockquote class="twitter-tweet" lang="fr"><p>Join us at Twitter <a href="https://twitter.com/Flight">@Flight</a> and learn how we can help you build the best mobile apps. October 22nd, in SF. Visit <a href="http://t.co/LyCCvuvn2R">http://t.co/LyCCvuvn2R</a></p>&mdash; TwitterDev (@TwitterDev) <a href="https://twitter.com/TwitterDev/status/509752513981988864">10 Septembre 2014</a></blockquote>
<h3 id="summarlargecards"><?php _e('Summary Large Image cards',JM_TC_DOC_TEXTDOMAIN);?></h3>
<blockquote class="twitter-tweet" lang="fr"><p>Everything you need to know about the Amazon Fire Phone <a href="http://t.co/uULA47di9M">http://t.co/uULA47di9M</a></p>&mdash; TechCrunch (@TechCrunch) <a href="https://twitter.com/TechCrunch/status/491955931719434241">23 Juillet 2014</a></blockquote>
...
<blockquote class="twitter-tweet" lang="fr"><p>Stunning photo of mountainous landscape and reflections <a href="http://t.co/esvsXTy7Tq">http://t.co/esvsXTy7Tq</a></p>&mdash; Flickr (@Flickr) <a href="https://twitter.com/Flickr/status/423511451970445312">15 Janvier 2014</a></blockquote>
<blockquote class="quote-doc"> <p><?php _e('The Photo Card puts the image front and center in the Tweet:',JM_TC_DOC_TEXTDOMAIN);?></p>
...
<ul class="jm-doc-photocard"> <li><strong>Web</strong>: <?php _e('maximum height of 375px, maximum width of 435px',JM_TC_DOC_TEXTDOMAIN);?></li>
...
<li><?php _e('Twitter will not create a photo card unless the twitter:image is of a minimum size of 280px wide by 150px tall. Images will not be cropped unless they have an exceptional aspect ratio',JM_TC_DOC_TEXTDOMAIN);?></li> </ul> </blockquote>
<h3 id="productcards"><?php echo __('Product cards',JM_TC_DOC_TEXTDOMAIN);?></h3>
<blockquote class="twitter-tweet" lang="fr"><p>Today marks 50 years since <a href="https://twitter.com/hashtag/The?src=hash">#The</a> Beatles took the US by storm! Listen to non-stop Beatles songs on 24/7 Beatles Radio: <a href="http://t.co/SMCaQalY4Y">http://t.co/SMCaQalY4Y</a></p>&mdash; iHeartRadio (@iHeartRadio) <a href="https://twitter.com/iHeartRadio/status/431829482291212288">7 Février 2014</a></blockquote>
...
<blockquote class="twitter-tweet" lang="fr"><p><a href="https://twitter.com/hashtag/Calistoga?src=hash">#Calistoga</a>, California - named one of America&#39;s Best Small Towns by <a href="https://twitter.com/fodorstravel">@fodorstravel</a> <a href="http://t.co/Hb5dwjhZHP">http://t.co/Hb5dwjhZHP</a> <a href="https://twitter.com/hashtag/VisitCA?src=hash">#VisitCA</a></p>&mdash; Visit California (@VisitCA) <a href="https://twitter.com/VisitCA/status/477565323206336512">13 Juin 2014</a></blockquote>
...
<div class="inbl"><blockquote class="twitter-tweet" lang="fr"><p>Sometimes I think my days can&#39;t get any more rediculous until today. <a href="https://t.co/x8HoullQMT">https://t.co/x8HoullQMT</a></p>&mdash; Gareth Paul Jones (@gpj) <a href="https://twitter.com/gpj/status/413394813854040064">18 Décembre 2013</a></blockquote></div><div class="inbl"><blockquote class="twitter-tweet" lang="fr"><p><a href="https://twitter.com/hashtag/SCOTD?src=hash">#SCOTD</a> is Stockholm, Sweden-based Daniel Rosenholm, aka <a href="https://twitter.com/dubiousquip">@dubiousquip</a> who creates a blend of blues, soul and pop. <a href="https://t.co/sVchJg3EgU">https://t.co/sVchJg3EgU</a></p>&mdash; SoundCloud (@SoundCloud) <a href="https://twitter.com/SoundCloud/status/459443749769453568">24 Avril 2014</a></blockquote></div>
...
<ul> <li><?php _e('Build a responsive and equivalent experience that works within all Twitter clients (including twitter.com, mobile.twitter.com, Twitter for iPhone and Twitter for Android). Cards that do not work in all Twitter clients listed will not be approved.',JM_TC_DOC_TEXTDOMAIN);?></li>
...
<li><?php _e('Link to a HTML page which falls back to mobile friendly content in case Flash is not available.',JM_TC_DOC_TEXTDOMAIN);?></li> </ul>
<p><strong><?php _e('Do not:',JM_TC_DOC_TEXTDOMAIN);?></strong></p>
<ul> <li><?php _e('Circumvent the intended use of the Card. Player Cards are reserved for linear audio and video consumption only.',JM_TC_DOC_TEXTDOMAIN);?></li>
...
<li><?php _e('Generate active mixed content browser warnings at any point during the audio or video experience, either on load or during play. For more information, see the',JM_TC_DOC_TEXTDOMAIN);?> <a href= "https://dev.twitter.com/docs/cards/troubleshooting#Active_Mixed_ContentSSL_Issue"><?php _e('Troubleshooting Guide',JM_TC_DOC_TEXTDOMAIN);?></a>.</li>
<li><?php _e('Set twitter:player to point directly at a .swf movie file.',JM_TC_DOC_TEXTDOMAIN);?></li> </ul> </blockquote><p><?php _e('Also be sure to check all the following point before <a href= "https://cards-dev.twitter.com/validator">asking for approval</a>. Here are the common issues with player cards:',JM_TC_DOC_TEXTDOMAIN);?></p>
<blockquote class="quote-doc"> <ol> <li><?php _e('The HTTPS lock is showing active mixed content warnings',JM_TC_DOC_TEXTDOMAIN);?></li>
...
</pre>  <p><?php _e('Source',JM_TC_DOC_TEXTDOMAIN);?> : <a href="https://dev.twitter.com/cards/mobile"><?php _e('App Installs and Deep-Linking',JM_TC_DOC_TEXTDOMAIN);?></a></p>
...
<p><a href="https://dev.twitter.com/docs/cards/analytics"><?php _e('See on dev.twitter.com',JM_TC_DOC_TEXTDOMAIN);?></a></p>
...
<p class="sub-bold"><?php _e('If you experience any issue or if you mess with this option just recover with the key :',JM_TC_DOC_TEXTDOMAIN);?><br /> <strong>jm_tc_twitter</strong></p>
...
<ul> <li><?php _e('<strong>Retina display</strong>: Be careful with Retina displays, image must be tall enough. Also make sure your image is not heavier than 1 MB if used for summary large cards',JM_TC_DOC_TEXTDOMAIN);?></li>
...
<li><?php _e('<strong>Product card options</strong> : You can set 2 key details for your product (e.g price, size, etc)',JM_TC_DOC_TEXTDOMAIN);?></li> </ul>
<div class="footer"> <h4 id="sources"><?php _e('Sources',JM_TC_DOC_TEXTDOMAIN);?></h4>
<ul> <li><a href="https://dev.twitter.com/docs/cards"><?php _e('Twitter cards documentation',JM_TC_DOC_TEXTDOMAIN);?></a></li>
<li><a href="https://dev.twitter.com/docs/cards/markup-reference"><?php _e('Meta tag references',JM_TC_DOC_TEXTDOMAIN);?></a></li> </ul>
