...
class cmb_Meta_Box
{
    ...
    protected static $mb_defaults = array(
        ...
        // Specific post IDs or page templates to display this metabox
        'cmb_styles' => true,
        // Include cmb bundled stylesheet
        'fields' => array(),
    );
    /**
    ...
    public static function save_fields($meta_box, $object_id, $object_type = '')
    {
        ...
        $meta_box['show_on'] = empty($meta_box['show_on']) ? array(
            'key' => false,
            'value' => false
        ) : $meta_box['show_on'];
