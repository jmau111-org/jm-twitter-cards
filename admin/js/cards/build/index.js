...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__wordpress_blocks__ = __webpack_require__(3);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__wordpress_editor__ = __webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__wordpress_element__ = __webpack_require__(6);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__wordpress_i18n__ = __webpack_require__(0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_attributes__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_supports__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_cardType__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_preview__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__style_scss__ = __webpack_require__(13);
...
Object(__WEBPACK_IMPORTED_MODULE_0__wordpress_blocks__["registerBlockType"])('jm-tc/cards', {
    ...
    icon: 'twitter',
    category: 'common',
    supports: __WEBPACK_IMPORTED_MODULE_6__components_supports__["a" /* Supports */],
    attributes: __WEBPACK_IMPORTED_MODULE_5__components_attributes__["a" /* Attributes */],
    ...
    edit: function edit(_ref) {
        ...
        return wp.element.createElement(
            ...
            null,
            wp.element.createElement(__WEBPACK_IMPORTED_MODULE_8__components_preview__["a" /* Preview */], { key: className, attributes: attributes }),
            wp.element.createElement(
                ...
                wp.element.createElement(
                    ...
                    wp.element.createElement(__WEBPACK_IMPORTED_MODULE_2__wordpress_components__["SelectControl"], {
                        ...
                        value: Object(__WEBPACK_IMPORTED_MODULE_7__components_cardType__["a" /* Type */])(attributes),
                ...
                wp.element.createElement(
                    ...
                    !cardImage && wp.element.createElement(
                        ...
                        {
                            instructions: Object(__WEBPACK_IMPORTED_MODULE_4__wordpress_i18n__["__"])("Using featured image is highly recommended but you can override this here. Upload image here or insert from media library to set another source for twitter image than featured image", "jm-tc"),
                            icon: "format-image",
                            label: "Image"
                        },
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Supports; });
var Supports = {
    className: false,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__wordpress_i18n__ = __webpack_require__(0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__title__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__cardType__ = __webpack_require__(1);
    ...
    return wp.element.createElement(
        ...
        wp.element.createElement(
            ...
            wp.element.createElement(
                ...
                Object(__WEBPACK_IMPORTED_MODULE_0__wordpress_i18n__["__"])("Your Twitter account name", "jm-tc")
            ),
            wp.element.createElement(
                "div",
        ...
        wp.element.createElement(
            ...
            'app' !== Object(__WEBPACK_IMPORTED_MODULE_2__cardType__["a" /* Type */])(attributes) && wp.element.createElement(
                "p",
                null,
                ...
                wp.element.createElement(
                    ...
                    'app' !== Object(__WEBPACK_IMPORTED_MODULE_2__cardType__["a" /* Type */])(attributes) && wp.element.createElement(
                        ...
                        wp.element.createElement(
                            "div",
                            {
                                className: "js-openLink u-block TwitterCardsGrid-col--12 TwitterCard-container " + Object(__WEBPACK_IMPORTED_MODULE_2__cardType__["a" /* Type */])(attributes) + "--small " + Object(__WEBPACK_IMPORTED_MODULE_2__cardType__["a" /* Type */])(attributes) + "--noImage" },
                            wp.element.createElement(
                                "div",
                                { className: Object(__WEBPACK_IMPORTED_MODULE_2__cardType__["a" /* Type */])(attributes) + "-image TwitterCardsGrid-float--prev" },
                                wp.element.createElement(
                                    "div",
                                    ...
                                    wp.element.createElement(
                                        ...
                                        { className: "tcu-imageWrapper",
                                            style: { backgroundImage: "url(" + Object(__WEBPACK_IMPORTED_MODULE_3__image__["a" /* Image */])(attributes) + ")" } },
                                        wp.element.createElement("img", { className: "u-block",
                                            alt: attributes.cardImageAlt || '',
                                            src: Object(__WEBPACK_IMPORTED_MODULE_3__image__["a" /* Image */])(attributes) })
                                    )
                                )
                            ),
                            wp.element.createElement(
                                "div",
                                {
                                    className: Object(__WEBPACK_IMPORTED_MODULE_2__cardType__["a" /* Type */])(attributes) + "-contentContainer TwitterCardsGrid-float--prev" },
                                wp.element.createElement(
                                    "div",
                                    { className: Object(__WEBPACK_IMPORTED_MODULE_2__cardType__["a" /* Type */])(attributes) + "-content TwitterCardsGrid-ltr" },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__wordpress_data__ = __webpack_require__(11);
